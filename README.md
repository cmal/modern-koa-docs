...
[![npm version](https://badgen.net/npm/v/modern-koa-docs)](https://www.npmjs.com/package/modern-koa-docs)
![project depencies](https://badgen.net/david/dep/soshnikov/modern-koa-docs)
[![Known Vulnerabilities](https://snyk.io/test/github/soshnikov/modern-koa-docs/badge.svg)](https://snyk.io/test/github/soshnikov/modern-koa-docs)
![MIT](https://badgen.net/badge/license/MIT/blue)
[![open issues](https://badgen.net/github/open-issues/soshnikov/modern-koa-docs)](https://github.com/soshnikov/modern-koa-docs/issues)
![last commit](https://badgen.net/github/last-commit/soshnikov/modern-koa-docs)

---

## Information about original project

This project is fork of [koa-docs](https://github.com/a-s-o/koa-docs)
...
```bash
npm install --save modern-koa-docs
```
...
- `validate`
  ...
  - `multipartOptions`: body for multipart, object which conforms to [Joi](https://github.com/hapijs/joi) validation
